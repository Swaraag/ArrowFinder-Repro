...
def main(model_config_file_path, train_file_path, val_file_path, history_output_dir, model_output_file_path):
    ...
    train_data_loader = DataLoader(train_data_objs, batch_size=hparams["batch_size"], shuffle=True, num_workers=0, pin_memory=True)
    val_data_loader   = DataLoader(val_data_objs, batch_size=hparams["batch_size"], shuffle=True, num_workers=0, pin_memory=True)
